...
for al in range(1, a + 1):
    print(al)
    u = 'http://msk.posrednikovzdes.net/adv.php?city=73&oper=3&metro=0&realty=0&oplt=0&price1=0&price2=0&page=%s&paiin=0' % al
    text = requests.get(u).text
    ...
    for i in tr:
        ...
        if len(td) == 9:
            ...
            x = {'room_num': room, 'metro': metro, 'pics': allPhoto,
                 ...
                 "url": url, "area": area, "adr": str(distr) + " " + str(street), "descr": descript}
